...
class _ModuloDeudasState extends State<ModuloDeudas> {
  ...
  Widget _buildSummaryCard() {
    ...
    final double progresoGeneral = totalDeuda > 0
        ? (1 - (totalPendiente / totalDeuda))
        : 0;
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    _formatCurrency(presupuestoDeudas),
                    style: const TextStyle(
                      color: AppPresupuestoColors.deudas,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
          ...
          Row(
            ...
            children: [
              Text(
                '${(progresoGeneral * 100).toStringAsFixed(1)}% pagado',
                style: const TextStyle(
                  color: AppColors.textSecondary,
                  fontSize: 12,
                ),
              ...
              Text(
                'Total: ${_formatCurrency(totalDeuda)}',
                style: const TextStyle(
                  color: AppColors.textSecondary,
                  fontSize: 12,
                ),
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                _formatCurrency(deuda.montoRestante),
                style: const TextStyle(
                  color: AppColors.textPrimary,
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
          ...
          Row(
            ...
            children: [
              Text(
                '${(deuda.progresoCuotas * 100).toStringAsFixed(0)}% amortizado',
                style: const TextStyle(
                  color: AppColors.textSecondary,
                  fontSize: 11,
                ),
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      final result = await Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              AgregarDeudaScreen(deudaParaEditar: deuda),
                        ),
                      );
                      if (result == true) _loadDeudas();
                    },
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: Text(
            '¿Confirmas el pago de la siguiente cuota a ${deuda.fuente}?',
