...
class _AgregarDeudaScreenState extends State<AgregarDeudaScreen> {
  ...
  void dispose() {
    ...
    _categoryScrollController.dispose();   // ✅ ahora sí existe
    super.dispose();
  }
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            const Text('Registrar obligación financiera',
                style: TextStyle(
          ...
          child: Row(
            children: [
              if (_isLoadingCategorias)
                ...
                Icon(_getIconForCategory(cat.nombre),
                    color: _getColorForCategory(cat.nombre), size: 20),
                    ...
                    ConstrainedBox(
                      ...
                      child: NotificationListener<ScrollNotification>(
                        ...
                        child: ListView.separated(
                          ...
                          // ✅ separador con nombres válidos (antes era (_, _))
                          separatorBuilder: (_, __) =>
                              const SizedBox(height: 12),
                          itemBuilder: (context, index) {
                            WidgetsBinding.instance.addPostFrameCallback((_) {
                              if (_categoryScrollController.hasClients) {
                                final hasMore = _categoryScrollController
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isSelected
              ? Border.all(
                  color: AppColors.error.withValues(alpha: 0.6), width: 1.5)
              : null,
          boxShadow: const [
            BoxShadow(
                color: Color(0xFF05060D), offset: Offset(3, 3), blurRadius: 8)
          ],
        ),
        child: Row(
          children: [
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(
              color: Color(0xFF05060D), offset: Offset(4, 4), blurRadius: 12),
          BoxShadow(
