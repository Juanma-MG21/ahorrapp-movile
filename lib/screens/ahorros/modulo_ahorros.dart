...
class _ModuloAhorrosState extends State<ModuloAhorros> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Error al cargar metas: $e')));
      }
    }
  }
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          final result = await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const AgregarAhorroScreen(),
            ),
          );
  ...
  Widget _buildSummaryCard() {
    ...
    final double progresoGeneral = totalObjetivo > 0
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    _formatCurrency(presupuestoAhorros),
                    style: const TextStyle(
                      color: AppPresupuestoColors.ahorros,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
          ...
          Row(
            ...
            children: [
              Text(
                '${(progresoGeneral * 100).toStringAsFixed(1)}% del objetivo total',
                style: const TextStyle(
                  color: AppColors.textSecondary,
                  fontSize: 12,
                ),
              ...
              Text(
                'Meta Global: ${_formatCurrency(totalObjetivo)}',
                style: const TextStyle(
                  color: AppColors.textSecondary,
                  fontSize: 12,
                ),
      ...
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                height: 44,
                decoration: BoxDecoration(
                  color: AppPresupuestoColors.ahorros.withValues(alpha: 0.1),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Faltan ${_formatCurrency(ahorro.restante)}',
                      style: const TextStyle(
                        color: AppColors.textSecondary,
                        fontSize: 12,
                      ),
              ...
              Text(
                _formatCurrency(ahorro.montoActual),
                style: const TextStyle(
                  color: AppColors.textPrimary,
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
          ...
          Row(
            ...
            children: [
              Text(
                '${(ahorro.progreso * 100).toStringAsFixed(0)}%',
                style: const TextStyle(
                  color: AppColors.textSecondary,
                  fontSize: 11,
                ),
                  ...
                  IconButton(
                    ...
                    onPressed: () async {
                      final result = await Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              AgregarAhorroScreen(ahorroParaEditar: ahorro),
                        ),
                      );
                      if (result == true) _loadAhorros();
                    },
                  ...
                  try {
                    ...
                    if (context.mounted) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Saldo actualizado con éxito'),
                        ),
                      );
                    }
                  } catch (e) {
