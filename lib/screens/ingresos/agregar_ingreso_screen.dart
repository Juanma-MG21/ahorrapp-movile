    ...
    return _NeumorphicContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _buildTextField(
              controller: _fuenteController, hint: 'Ej: Empresa XYZ'),
          const SizedBox(height: 18),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: isSelected
              ? Border.all(
                  color: const Color(0xFF4ADE80).withOpacity(0.6), width: 1.5)
              : null,
          boxShadow: const [
            BoxShadow(
...
}  // ✅ CIERRE de _AgregarIngresoScreenState (faltaba esto)
